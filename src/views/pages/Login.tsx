                ...
                <CCardBody>
                  <CForm onSubmit={handlSubmit}>
                    ...
                    <CInputGroup className="mb-3">
                      ...
                      <CInput type="text" placeholder="Username" autoComplete="email" name="email" onChange={handlerInputChange} />
                    </CInputGroup>
                    <CInputGroup className="mb-4">
                      ...
                      <CInput type="password" placeholder="Password" autoComplete="password" name="password" onChange={handlerInputChange} />
                    </CInputGroup>
                    <CRow>
                      <CCol xs="6">
